...
/// never share a sentence**. The cull identifies its suggestions with a star and its own words.
...
extension Strings {
    public enum LightTable {
        ...
        public static var suggested: String {
            String(localized: "lt.suggested", defaultValue: "Suggested",
                   comment: "A cull suggestion, not a personal Keep mark.")
        }
        public static var suggestionHelp: String {
            String(localized: "lt.suggestionHelp",
                   defaultValue: "Suggested by the cull. Leaving it unchanged when you finish this burst keeps it; D drops it.",
                   comment: "Explains what accepting a cull suggestion does.")
        }
        public static var cullClearWin: String {
            String(localized: "lt.cullClearWin", defaultValue: "Suggested by the cull",
                   comment: "Never 'AI', never 'score', never 'confidence'.")
        }
        public static var cullMaybe: String {
            String(localized: "lt.cullMaybe", defaultValue: "Suggested by the cull", comment: "The cull's line.")
        }
        ...
        public static func cullMaybeWhy(_ why: String) -> String {
            String(localized: "lt.cullMaybeWhy", defaultValue: "Suggested — \(why)",
