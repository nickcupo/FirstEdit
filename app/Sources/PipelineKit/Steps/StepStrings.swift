...
extension Strings {
    ...
    public enum Presets {
        ...
        public static func willBeEdited(_ n: Int) -> String {
            String(localized: "presets.willBeEdited", defaultValue: "\(n) frames selected for presets.",
                   comment: "Frames included in the preset selection; existing sidecars may be preserved.")
        }
        public static func splitYours(_ n: Int) -> String {
            // Only explicit Keep presses; the sidebar's keepers also include
            // the accepted cull picks named on the next line.
        ...
        public static func splitAgreed(_ n: Int) -> String {
            String(localized: "presets.splitAgreed",
                   defaultValue: "\(n) cull picks you left unchanged in reviewed bursts",
        ...
        public static var alsoDropped: String {
            t("presets.alsoDropped", "Also write presets for the other frames", "Includes all other frames, not only explicit drops.")
        }
