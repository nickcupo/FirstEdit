...
public enum Strings {
    ...
    public enum Library {
        ...
        public static func kept(_ n: Int) -> String {
            String(localized: "library.kept", defaultValue: "\(n) you kept",
                   comment: "His number of keepers, named as his. Never the cull's, and never a sum.")
        }
        ...
        public static func framesAndKept(_ n: Int, _ kept: Int) -> String {
            String(localized: "library.framesAndKept", defaultValue: "\(n) frames · \(kept) you kept",
                   comment: "A shoot row's subtitle. The second number is his, named as his, never the cull's.")
        }
    ...
    public enum Overview {
        ...
        public static var youKept: String { s("overview.youKept", "You kept", "His keepers, by his own presses.") }
        public static var youPutOut: String { s("overview.youPutOut", "You put out", "His drops.") }
