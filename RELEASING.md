...
git tag v0.1.4                             # on the commit that is going out
```

Version 0.1.4 supersedes the earlier development builds. Keep `CHANGELOG.md`,
...
```sh
ls dist/                                   # First-Edit-0.1.4.dmg and its NOTICES
...
xcrun stapler validate dist/First-Edit-0.1.4.dmg
spctl --assess --type open --context context:primary-signature -v dist/First-Edit-0.1.4.dmg
hdiutil attach dist/First-Edit-0.1.4.dmg -nobrowse   # then open the app from the image once, and quit it
```
...
git push public v0.1.4                     # this one tag, never --tags
gh release create v0.1.4 dist/First-Edit-0.1.4.dmg dist/First-Edit-0.1.4-NOTICES.md \
